...
## Setup
1. fork this repo
2. Clone from your forked version
3. create an `answers.js` file.
4. Write your answers in this file. Use comments for the non-code responses.
...
* Arrays
* Objects
* (We've also seen primitive types null and undefined, but those aren't relevant to this assignment)
